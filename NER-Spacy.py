...
def toon_interactieve_opties():
    opties = {}
    opties['include_entities'] = input("Wilt u ook entiteiten zoals plaatsnamen en objecten meenemen? (ja/nee) [Enter=ja]: ").strip().lower() != "nee"
    opties['lowercase'] = input("Wilt u de termen omzetten naar kleine letters? (ja/nee) [Enter=ja]: ").strip().lower() != "nee"
    opties['sort_output'] = input("Wilt u de termen alfabetisch sorteren? (ja/nee) [Enter=ja]: ").strip().lower() != "nee"
    return opties
...
def main():
    ...
    instellingen = toon_interactieve_opties()
    include_entities = instellingen['include_entities']
    lowercase = instellingen['lowercase']
    sort_output = instellingen['sort_output']
