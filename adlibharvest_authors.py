...
BASE_URL = "https://rce.adlibhosting.com/harvest/wwwopac.ashx?database=books&search=author.name=*&limit=3000"
TOTAL_RECORDS = 253326
LIMIT = 3000
...
def save_records(data, index):
    filename = f"adlibauthors_{index}.xml"
...
def main():
    ...
    index = 1
    while os.path.exists(f"adlibauthors_{index}.xml"):
        index += 1
