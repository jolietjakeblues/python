...
BASE_URL = "https://rce.adlibhosting.com/harvest/wwwopac.ashx?database=thesau&search=priref=*&limit=3000"
TOTAL_RECORDS = 80360
LIMIT = 3000
...
def save_records(data, index):
    filename = f"adlibtesau_{index}.xml"
...
def main():
    ...
    index = 1
    while os.path.exists(f"adlibthesau_{index}.xml"):
        index += 1
