...
BASE_URL = "https://rce.adlibhosting.com/harvest/wwwopac.ashx?database=books&search=all&limit=3000"
TOTAL_RECORDS = 326652
LIMIT = 3000
...
def save_records(data, index):
    filename = f"adliballes_{index}.xml"
...
def main():
    ...
    index = 1
    while os.path.exists(f"adliballes_{index}.xml"):
        index += 1
