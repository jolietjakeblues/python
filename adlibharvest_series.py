...
BASE_URL = "https://rce.adlibhosting.com/harvest/wwwopac.ashx?database=series&search=all&limit=3000"
TOTAL_RECORDS = 12299
LIMIT = 3000
...
def save_records(data, index):
    filename = f"adlibseries_{index}.xml"
...
def main():
    ...
    index = 1
    while os.path.exists(f"adlibseries_{index}.xml"):
        index += 1
